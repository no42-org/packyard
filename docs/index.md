...
Packyard is a self-hosted, authenticated distribution platform for LTS releases. It serves RPM, DEB, and OCI artefacts with per-component subscription key scoping, Prometheus metrics, and automated keystore backups.
